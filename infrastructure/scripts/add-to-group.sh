...
if [ "$#" -lt 2 ]; then
    ...
    echo "  ✓ Update the project's code-graph script to also update group graph"
    echo "  ✓ Build the group graph (indexes parent directory)"
    echo ""
    exit 1
fi
...
print_header "📂 Adding $PROJECT_NAME to group: $GROUP"
...
# Main execution
echo "🔄 Code-Graph Update Started: $(date)" | tee -a "$LOCAL_LOG"
...
# Step 5: Summary
#
print_header "✨ Group Setup Complete! ✨"

echo "Project: $PROJECT_NAME"
echo "Group: $GROUP"
echo ""
echo "📊 Graph Databases:"
echo "  • $DB_PROJECT (project)"
echo "  • $DB_GROUP (group - indexes all projects in parent directory)"
echo ""
echo "📝 Commands:"
