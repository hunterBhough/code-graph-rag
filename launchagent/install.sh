#!/usr/bin/env bash
# LaunchAgent installation script for weavr
...
check_prerequisites() {
    ...
    if ! command -v /Users/hunter/code/ai_agency/shared/mcp-servers/weavr/.venv/bin/python &> /dev/null; then
        log_error "Python executable not found: /Users/hunter/code/ai_agency/shared/mcp-servers/weavr/.venv/bin/python"
        exit 1
    fi
...
verify_running() {
    ...
    if launchctl list | grep -q "${PLIST_NAME%.plist}"; then
        ...
        if curl -s -f "http://127.0.0.1:9001/health" > /dev/null 2>&1; then
            ...
            log_info "View logs with: tail -f /Users/hunter/Library/Logs/weavr-*.log"
        fi
    else
        log_error "Service is not running. Check logs for errors:"
        log_info "  stdout: /Users/hunter/Library/Logs/weavr-stdout.log"
        log_info "  stderr: /Users/hunter/Library/Logs/weavr-stderr.log"
        exit 1
    fi
}
...
Logs:
  stdout: /Users/hunter/Library/Logs/weavr-stdout.log
  stderr: /Users/hunter/Library/Logs/weavr-stderr.log
  View:   tail -f /Users/hunter/Library/Logs/weavr-*.log
