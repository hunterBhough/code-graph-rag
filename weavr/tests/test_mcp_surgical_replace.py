"""Tests for MCP tools surgical_replace_code method."""
...
class TestSurgicalReplaceErrorHandling:
    ...
    async def test_replace_with_exception(
        ...
        mcp_registry._file_editor_tool.function.side_effect = Exception(
            "Permission denied"
        )
...
class TestSurgicalReplaceIntegration:
    ...
    async def test_replace_verifies_parameters_passed(
        ...
        mcp_registry._file_editor_tool.function.return_value = "Success"
